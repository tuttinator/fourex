...
export function createDemoGameState(width = 20, height = 20): GameState {
  ...
  return {
    ...
    stockpiles: {
      player_alpha: { food: 150, wood: 80, ore: 40, crystal: 10, science: 0 },
      player_beta: { food: 120, wood: 100, ore: 60, crystal: 5, science: 0 },
      player_gamma: { food: 90, wood: 60, ore: 30, crystal: 20, science: 0 },
      player_delta: { food: 110, wood: 70, ore: 50, crystal: 15, science: 0 },
    },
    research: {
      player_alpha: { completed: [], active: null, progress: 0 },
      player_beta: { completed: [], active: null, progress: 0 },
      player_gamma: { completed: [], active: null, progress: 0 },
      player_delta: { completed: [], active: null, progress: 0 },
    },
